...
namespace MoreMountains.Tools
{
		...
		MMEventListener<MMSoundManagerTrackFadeEvent>
	{
		...
		{
			/*return PlaySound(audioClip, options.Location,
    ...
    bool useSpatialBlendCurve = false, AnimationCurve spatialBlendCurve = null, bool useReverbZoneMixCurve = false, AnimationCurve reverbZoneMixCurve = null
        ...
        {
            if (this == null || audioClip == null)
                return null;

            AudioSource audioSource = recycleAudioSource ?? _pool.GetAvailableAudioSource(PoolCanExpand, this.transform);
            ...
            if (attachToTransform != null)
            {
                MMFollowTarget followTarget = audioSource.gameObject.MMGetComponentNoAlloc<MMFollowTarget>() ??
                                             audioSource.gameObject.AddComponent<MMFollowTarget>();
            ...
            if (settingsSo != null)
            {
                ...
                {
                    case MMSoundManagerTracks.Master: audioSource.outputAudioMixerGroup = settingsSo.MasterAudioMixerGroup; break;
                    case MMSoundManagerTracks.Music: audioSource.outputAudioMixerGroup = settingsSo.MusicAudioMixerGroup; break;
                    case MMSoundManagerTracks.Sfx: audioSource.outputAudioMixerGroup = settingsSo.SfxAudioMixerGroup; break;
                    case MMSoundManagerTracks.UI: audioSource.outputAudioMixerGroup = settingsSo.UIAudioMixerGroup; break;
                }
            }
            ...
            if (!loop && recycleAudioSource == null)
            {
            ...
            // … остальной код для Solo и _sounds остаётся без изменений …
